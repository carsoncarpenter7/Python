...
## Objectives
* Practice using built-in data types (string, list, set, dictionaries)
...
# Rubric
Each exercise is worth 5 points. There is a total of 20 points possible. Your program must compile, in other words be syntactically correct, before it is graded. Submissions that do not compile shall be assigned a zero grade. 
