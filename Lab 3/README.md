# CPSC 223p - Lab 03
Let's practice reading and writing to files using strings and lists.
And let's write a class!

## Objectives
* Practice using built-in data types (string, list, set, dictionaries)
* Open files for reading and writing; read and write to files
* Write a rudimentary class
